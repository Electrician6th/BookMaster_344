...
public partial class BookmasterContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Server=WIN10\\SQLEXPRESS;Database=Bookmaster34;Trusted_Connection=true;TrustServerCertificate=true");
